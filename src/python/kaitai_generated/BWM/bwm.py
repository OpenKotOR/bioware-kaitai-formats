...
class Bwm(KaitaiStruct):
        ...
        def _read(self):
            ...
            for i in range(self._root.data_table_offsets.adjacency_count):
                self.adjacencies.append(
                    Bwm.AdjacencyTriplet(self._io, self, self._root)
                )
    ...
    class AdjacencyTriplet(KaitaiStruct):
        ...
        def edge_0_face_index(self):
            ...
            self._m_edge_0_face_index = (
                self.edge_0_adjacency // 3 if self.edge_0_adjacency != -1 else -1
            )
        ...
        def edge_1_face_index(self):
            ...
            self._m_edge_1_face_index = (
                self.edge_1_adjacency // 3 if self.edge_1_adjacency != -1 else -1
            )
        ...
        def edge_2_face_index(self):
            ...
            self._m_edge_2_face_index = (
                self.edge_2_adjacency // 3 if self.edge_2_adjacency != -1 else -1
            )
    ...
    def aabb_nodes(self):
        ...
        if (self._root.walkmesh_properties.walkmesh_type == 1) and (
            self._root.data_table_offsets.aabb_count > 0
        ):
            pass
            _pos = self._io.pos()
    ...
    def adjacencies(self):
        ...
        if (self._root.walkmesh_properties.walkmesh_type == 1) and (
            self._root.data_table_offsets.adjacency_count > 0
        ):
            pass
            _pos = self._io.pos()
    ...
    def edges(self):
        ...
        if (self._root.walkmesh_properties.walkmesh_type == 1) and (
            self._root.data_table_offsets.edge_count > 0
        ):
            pass
            _pos = self._io.pos()
    ...
    def normals(self):
        ...
        if (self._root.walkmesh_properties.walkmesh_type == 1) and (
            self._root.data_table_offsets.face_count > 0
        ):
            pass
            _pos = self._io.pos()
    ...
    def perimeters(self):
        ...
        if (self._root.walkmesh_properties.walkmesh_type == 1) and (
            self._root.data_table_offsets.perimeter_count > 0
        ):
            pass
            _pos = self._io.pos()
    ...
    def planar_distances(self):
        ...
        if (self._root.walkmesh_properties.walkmesh_type == 1) and (
            ...
            self._m_planar_distances = Bwm.PlanarDistancesArray(
